const TimeLineItem = ({ data, index }) => {
  return (
    ...
    >
      <div className="h-full text-sm sm:text-lg border-2 border-[#111e27] dark:border-white text-[#111e27] font-medium dark:text-[#ffce45] w-[90%] py-4 px-3 rounded relative">
